 ...
 */
public class ExtendedConnectionPoolImpl implements Runnable, ExtendedConnectionPool {
    ...
    public ExtendedConnectionPoolImpl(String driver, String url, String username,
